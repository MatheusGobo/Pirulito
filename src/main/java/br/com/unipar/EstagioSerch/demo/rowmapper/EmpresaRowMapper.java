...
//
//import br.com.unipar.EstagioSerch.demo.models.CategoriaEmpresa;
...
////        CategoriaEmpresa categoriaEmpresa =  CategoriaEmpresa.valueOf(rs.getString("tp_categoriaEmpresa"));
////        Date dt_registro = rs.getDate("dt_registro");
////
////        return new Empresa(cd_empresa, nm_razao, nm_fantasia, nr_cnpj, nm_representante, categoriaEmpresa, dt_registro);
//
//    }
//
//}
